...
@Component({
  selector: 'app-file-upload-application',
  standalone: true,
  imports: [CommonModule, NzButtonModule, NzIconModule],
  templateUrl: './file-upload-application.component.html',
  styleUrls: ['./file-upload-application.component.css']
})
export class FileUploadApplicationComponent {
  ...
  async onDroppedFile() {
    if (this.files) {
      try {
        ...
        const response = await this.fileManagerService.uploadApplication(this.files)
